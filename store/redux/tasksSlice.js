...
const initialState = {
  tasks: [
    ...
    { id: Math.random() * 89328, listTitle: "list5", title: "task7" },
    { id: Math.random() * 89328, listTitle: "list4", title: "task7" },
    { id: Math.random() * 89328, listTitle: "list1", title: "task7" },
    { id: Math.random() * 89328, listTitle: "list4", title: "task7" },
    { id: Math.random() * 89328, listTitle: "list2", title: "task7" },
    { id: Math.random() * 89328, listTitle: "list3", title: "task7" },
    { id: Math.random() * 89328, listTitle: "list2", title: "task7" },
  ],
};
